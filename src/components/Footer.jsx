        ...
        <footer className="text-blueGray-700 transition duration-500 ease-in-out transform">
            ...
            <div className="flex flex-wrap flex-grow mt-8 -mb-10 text-left md:pl-20 md:mt-0 ">
              <div className="w-full px-4 lg:w-1/3 md:w-1/2">
                ...
                <nav className="mb-10 space-y-4 list-none">
                  <li>
                    <Link
                      className={
                        "mr-1 text-sm text-blueGray-500 transition duration-500 ease-in-out transform rounded-sm focus:shadow-outline focus:outline-none focus:ring-2 ring-offset-current ring-offset-2"
                      }
                      to="/privacy"
                    >
                      Privacy Policy
                ...
                <nav className="mb-10 space-y-4 list-none">
                  <li>
                    <a
                      ...
                      className=" mr-1 text-sm text-blueGray-500 transition duration-500 ease-in-out transform rounded-sm focus:shadow-outline focus:outline-none focus:ring-2 ring-offset-current ring-offset-2"
                    >
                      Twitter
                    </a>
                  </li>
                  <li>
                    <a
                      href={"https://discord.gg/gsaV6sPpC4"}
                      className=" mr-1 text-sm text-blueGray-500 transition duration-500 ease-in-out transform rounded-sm focus:shadow-outline focus:outline-none focus:ring-2 ring-offset-current ring-offset-2"
                    >
                      Discord
                    </a>
              ...
              <div className="w-full px-4 lg:w-1/3 md:w-1/2">
                ...
                <nav className="mb-10 space-y-4 list-none">
                  <li>
                    <a
                      href={"https://support.xoniaapp.com"}
                      className=" mr-1 text-sm text-blueGray-500 transition duration-500 ease-in-out transform rounded-sm focus:shadow-outline focus:outline-none focus:ring-2 ring-offset-current ring-offset-2"
                    >
                      Support
                    </a>
          ...
          <div className="w-full px-8 mt-4 rounded-b-lg bg-blueGray-50">
            <div className="container flex flex-col flex-wrap px-5 py-6 mx-auto sm:flex-row">
              <p
                style={{ color: "white" }}
                className="text-sm text-center text-black sm:text-left "
              >
                ©2021 Xonia, Inc.
              </p>

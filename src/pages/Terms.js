  ...
  return (
    <div>
      ...
      <div>
        ...
        <p>
          Welcome to <b>Xonia, Inc</b> (“Company”, “we”, “our”, “us”)!
        </p>
        <p>
          These Terms of Service (“Terms”, “Terms of Service”) govern your use
          of our website located at <b>xoniaapp.com</b> (together or
          individually “Service”) operated by <b>Xonia, Inc</b>.
        </p>
        <p>
        ...
        <p>
          ...
          <b>support@xoniaapp.com</b> so we can try to find a solution. These
        ...
        <p>
          ...
          renew under the exact same conditions unless you cancel it or Xonia,
          ...
          support@xoniaapp.com customer support team.
        </p>
        <p>
          A valid payment method is required to process the payment for your
          subscription. You shall provide Xonia, Inc with accurate and complete
          ...
          you automatically authorize Xonia, Inc to charge all Subscription fees
          incurred through your account to any such payment instruments.
        </p>
        <p>
          Should automatic billing fail to occur for any reason, Xonia, Inc
        ...
        <p>
          Xonia, Inc may, at its sole discretion, offer a Subscription with a
        ...
        <p>
          ...
          Trial, you will not be charged by Xonia, Inc until Free Trial has
        ...
        <p>
          At any time and without notice, Xonia, Inc reserves the right to (i)
        ...
        <p>
          Xonia, Inc, in its sole discretion and at any time, may modify
        ...
        <p>
          Xonia, Inc will provide you with a reasonable prior notice of any
        ...
        <p>
          Xonia, Inc has the right but not the obligation to monitor and edit
          all Content provided by users.
        </p>
        <p>
          In addition, Content found on or through this Service are the property
          of Xonia, Inc or used with permission. You may not distribute, modify,
        ...
        <p>
          ...
          property of Xonia, Inc and its licensors. Service is protected by
          ...
          without the prior written consent of Xonia, Inc.
        </p>
        <p>
        ...
        <p>
          ...
          to support@xoniaapp.com, with the subject line: “Copyright
        ...
        <p>
          You can contact our Copyright Agent via email at support@xoniaapp.com.
        </p>
        <p>
          17. <b>Error Reporting and Feedback</b>
        </p>
        <p>
          You may provide us either directly at support@xoniaapp.com or via
        ...
        <p>
          ...
          that are not owned or controlled by Xonia, Inc.
        </p>
        <p>
          Xonia, Inc has no control over, and assumes no responsibility for the
        ...
        <p>
          ...
          laws of Germany, which governing law applies to agreement without
        ...
        <p>
          ...
          email: <b>support@xoniaapp.com</b>.
        </p>
      </div>
      <br />
      <hr />

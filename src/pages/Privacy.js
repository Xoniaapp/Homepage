...
function Privacy() {
  return (
    <div>
      ...
      <br />
      <p style={{ textAlign: "center" }}>Effective date: 2021-09-01</p>
      <br />
      <p style={{ textAlign: "center" }}>
        1. <b>Introduction</b>
      </p>
      <p style={{ textAlign: "center" }}>
        Welcome to <b> Xonia, Inc</b>.
      </p>
      <br />
      <p style={{ textAlign: "center" }}>
        <b>Xonia, Inc</b> (“us”, “we”, or “our”) operates <b>xoniaapp.com</b>{" "}
        (hereinafter referred to as <b>“Service”</b>).
      </p>
      <p>
        Our Privacy Policy governs your visit to <b>xoniaapp.com</b>, and
      ...
      <br />
      <p>
        <b>SERVICE</b> means the xoniaapp.com website operated by Xonia, Inc.
      </p>
      <p>
      ...
      <p>Xonia, Inc uses the collected data for various purposes:</p>
      ...
      <p>
        Xonia, Inc will take all the steps reasonably necessary to ensure that
      ...
      <p>
        ...
        please send your request(s) by email: <b>support@xoniaapp.com</b>.
      </p>
      <p>
      ...
      <p>
        ...
        by email: <b>support@xoniaapp.com</b>.
      </p>
      <br />
      <hr />
      <Footer />
